...
export const FIELD_TYPES: FieldTypeMeta[] = [
  ...
  { value: "DROPDOWN", label: "Dropdown", group: "Lựa chọn", hasOptions: true },
  { value: "RADIO", label: "Radio", group: "Lựa chọn", hasOptions: true },
  { value: "CHECKBOX", label: "Checkbox", group: "Lựa chọn", hasOptions: true },
  { value: "MULTI_SELECT", label: "Multi-select", group: "Lựa chọn", hasOptions: true },
  { value: "YES_NO", label: "Yes / No", group: "Lựa chọn" },
  { value: "RATING", label: "Rating (sao)", group: "Đo lường" },
  { value: "SLIDER", label: "Slider", group: "Đo lường" },
