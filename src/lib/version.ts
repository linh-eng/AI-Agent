...
export const APP_RELEASE_NAME = "Dịch vụ: xác nhận tạo nhanh nhóm, multi-select công nghệ & protocol, vật tư định mức (SL/ĐVT/bắt buộc); danh sách đổi wording rõ hơn (\"1 công nghệ · 2 vật tư\" thay \"0 CN · 2 VT\")";
