...
async function main() {
  ...
  const dmkProducts = [
    { sku: "SP-DMK-SEBUM", name: "DMK Sebum Soak", category: "Làm sạch chuyên sâu", volume: "60ml",
      ...
      usage: "Tại spa: rửa mặt → trộn 1ml Sebum Soak + 1ml Aqua d'herb, ủ nilon và khăn ấm 3-5 phút tùy độ bã nhờn → lau bớt sản phẩm rồi lấy mụn → lau sạch, sát khuẩn. Tại nhà: 1ml Sebum Soak + 1ml Aqua, bôi lên da như kem dưỡng, để 5 phút (không cần ủ nóng), rửa sạch nước ấm. Bán chiết: 5ml Sebum Soak + 5ml Aqua.",
      frequency: "1 tuần/lần, những lần sau có thể giãn ra hoặc giảm định lượng tùy độ dầu và bít tắc. Tại nhà 1-2 lần/tuần (phải đủ ẩm để không kích ứng/viêm)." },
    { sku: "SP-DMK-EPITOXYL", name: "DMK Epitoxyl (Skin Cleansing Tonic)", category: "Tiêu độc da", volume: "60ml",
      ...
      usage: "Đổ sản phẩm vào miếng bông tẩy trang, lau lên mặt/cổ/ức (tránh vùng dưới mắt), để 3-5 phút, có thể xông hơi rồi lau sạch. Tại spa: sau Sebum Soak và lấy mụn → lau Epitoxyl → peel. Tại nhà: sau rửa mặt/tẩy da chết, lau sạch rồi làm tiếp các bước CS dưỡng.", frequency: "1-2 lần/tuần" },
    { sku: "SP-DMK-PROZYME", name: "DMK Prozyme (Exfoliating Enzyme Powder)", category: "Trị liệu bề mặt (enzyme)",
      ...
      contraindications: "2 enzyme (papain, bromelain) chỉ hoạt động hiệu quả nếu đủ ẩm và nóng — nếu không ủ nóng đúng/đủ thì không đạt hiệu quả; làm xong không hiệu quả phải kiểm tra lại bước ủ nóng.",
      usage: "2gr bột Prozyme pha với 4ml Aqua d'herb, quét lên da rồi ủ nóng 15-25 phút tùy độ sừng. Ủ nóng đúng: khăn/bộ ủ nóng nhất trong mức chịu được của khách + xông hơi + thay khăn liên tục. Sau đó quét Enzyme 1 pha Exoderma Peel để dọn nốt phần sừng còn lại." },
    ...
    { sku: "SP-DMK-PORERED", name: "DMK Pore Reduction Plus", category: "Se khít lỗ chân lông", volume: "60ml", type: "BOTH",
      benefits: "Se khít, thu nhỏ lỗ chân lông giãn rộng; kiềm dầu, làm mịn bề mặt và cải thiện kết cấu da.",
      suitableFor: "Da dầu, lỗ chân lông to, da sần sùi kém mịn." },
    { sku: "SP-DMK-MELANOTECH", name: "DMK Melanotech Drops", category: "Trị nám / sắc tố (home-care)", volume: "12ml", type: "HOME_CARE",
      benefits: "Serum đặc trị sắc tố dùng tại nhà: hỗ trợ ức chế và làm mờ tăng sắc tố, đều màu da; phối hợp trong liệu trình làm sáng/trị nám.",
      suitableFor: "Nám, tàn nhang, thâm sau mụn, da không đều màu.",
      usage: "Bôi lượng nhỏ lên vùng sắc tố sau bước làm sạch, trước kem dưỡng." },
    { sku: "SP-DMK-ENBIOMENT", name: "DMK Enbioment Serum", category: "Cân bằng hệ vi sinh da", volume: "30ml", type: "HOME_CARE",
      benefits: "Serum probiotic/tiền sinh học hỗ trợ phục hồi và cân bằng hệ vi sinh (microbiome) trên da, củng cố hàng rào bảo vệ, giảm nhạy cảm.",
      suitableFor: "Da yếu, mất cân bằng, dễ kích ứng, da sau liệu trình xâm lấn." },
    { sku: "SP-DMK-BETAGEL", name: "DMK Beta Gel", category: "Phục hồi / kháng viêm (home-care)", volume: "30ml", type: "HOME_CARE",
      benefits: "Gel chứa Beta-glucan: làm dịu, kháng viêm, hỗ trợ miễn dịch da, thúc đẩy lành thương, cấp ẩm và làm dịu mẩn đỏ; hỗ trợ phục hồi sau mụn/sau trị liệu.",
      suitableFor: "Da mụn viêm, da đỏ kích ứng, da sau peel/laser; là sản phẩm tại nhà bắt buộc trong nhiều liệu trình.",
      usage: "Chấm/bôi lớp mỏng lên vùng viêm đỏ hoặc toàn mặt sau bước dưỡng." },
    ...
    { sku: "SP-DMK-HMMIST-HC", name: "DMK Herb & Mineral Mist (Home-care)", category: "Xịt khoáng cân bằng", volume: "60ml", type: "HOME_CARE",
      benefits: "Xịt thảo mộc & khoáng chất giúp cấp ẩm tức thì, làm dịu, cân bằng pH và tăng thẩm thấu dưỡng chất ở bước sau.",
      suitableFor: "Mọi loại da; dùng sau làm sạch và trước/giữa các bước dưỡng.",
      usage: "Xịt cách mặt 20-30cm sau khi rửa mặt hoặc bất cứ lúc nào da cần cấp ẩm." },
    ...
    { sku: "SP-DMK-ACTROL", name: "DMK Actrol Powder", category: "Bột kiềm dầu / kháng khuẩn", volume: "10g", type: "HOME_CARE",
      benefits: "Bột kiềm dầu, hút nhờn và hỗ trợ kháng khuẩn, giữ da khô thoáng, giảm bóng dầu và hạn chế môi trường sinh mụn.",
      suitableFor: "Da dầu, da mụn, vùng chữ T nhiều dầu.",
      usage: "Phủ nhẹ lên vùng da dầu/mụn; có thể dùng ban ngày hoặc ban đêm." },
  ];
