...
async function main() {
  ...
  const dmkProducts = [
    ...
    { sku: "SP-DMK-PORERED", name: "DMK Pore Reduction Plus", category: "Se khít lỗ chân lông", volume: "30ml", type: "BOTH",
      ...
      usage: "Bôi giảm viêm & ức chế sắc tố sau điều trị bề mặt: 7 giọt. Trong ủ siêu dưỡng: 0.4ml (7 giọt)." },
    { sku: "SP-DMK-MELANOTECH", name: "DMK Melanotech Drops", category: "Trị nám / sắc tố (home-care)", volume: "30ml", type: "HOME_CARE",
      ...
      usage: "Bôi ức chế sắc tố: 7 giọt. Trong ủ siêu dưỡng: 0.4ml (7 giọt)." },
    { sku: "SP-DMK-ENBIOMENT", name: "DMK Enbioment Serum", category: "Cân bằng hệ vi sinh da", volume: "30ml", type: "HOME_CARE",
      ...
      usage: "Trong ủ siêu dưỡng: 1ml." },
    { sku: "SP-DMK-BETAGEL", name: "DMK Beta Gel", category: "Phục hồi / kháng viêm (home-care)", volume: "30ml", type: "HOME_CARE",
      benefits: "Phục hồi da hư tổn, sửa chữa hệ miễn dịch của da (theo tài liệu DMK). Chứa Beta-glucan: làm dịu, kháng viêm, cấp ẩm và làm dịu mẩn đỏ.",
      suitableFor: "Da mụn viêm, da đỏ kích ứng, da sau peel/laser; là sản phẩm tại nhà bắt buộc trong nhiều liệu trình.",
      usage: "Ủ siêu dưỡng: 1ml. Chăm sóc sau Alkaline Wash: bôi 3-4 lần/ngày (giai đoạn phục hồi 4 lần/ngày)." },
